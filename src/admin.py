...
def setup_admin(app):
    ...
    admin.add_view(ModelView(Personaje_favorito, db.session))
    admin.add_view(ModelView(Vehicle_favorito, db.session))
    admin.add_view(ModelView(Planeta_favorito, db.session))
